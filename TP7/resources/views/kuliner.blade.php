    ...
    <div class="container mx-auto">
        ...
        <div class="space-y-12 max-w-4xl mx-auto">
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden md:flex transition-shadow duration-300 hover:shadow-xl" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="md:w-1/2">
                    <img src="https://images.unsplash.com/photo-1588012886079-ba175d78a8b1?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Coto Makassar" class="w-full h-64 md:h-full object-cover"> {{-- Ganti dengan path gambar yang sesuai --}}
                </div>
                {{-- Deskripsi di Kanan --}}
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden md:flex transition-shadow duration-300 hover:shadow-xl" data-aos="fade-up" data-aos-delay="400">
                {{-- Gambar di Kiri --}}
                 <div class="md:w-1/2">
                    <img src="https://images.unsplash.com/photo-1550989460-0d9b6a12f45c?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Pisang Epe" class="w-full h-64 md:h-full object-cover"> {{-- Ganti dengan path gambar yang sesuai --}}
                </div>
                {{-- Deskripsi di Kanan --}}
                <div class="p-6 md:p-8 md:w-1/2 flex flex-col justify-center">
             ...
             {{-- Tambahkan item kuliner lainnya di sini dengan pola yang sama --}}
             {{-- Anda bisa selang-seling posisi gambar (kiri/kanan) dengan md:order-1 dan md:order-2 --}}
